...
We collect temperature data from your selected sensors to analyze indoor overheating trends. 

### What we collect:
- Your telephone number (used **only once** to determine the country of origin and ensure data quality, and immediately deleted). Blind signatures ensure that your phone number and the data you submit are never connected.
- Hourly aggregated temperature data (mean, min, max) and your postal code.
- A pseudonymized device identifier (Donor ID) to link your readings over time without knowing who you are.
- Room names are hashed locally on your device before transmission. We cannot read the original names of your rooms.

### Your Rights:
You can stop data collection at any time by uninstalling the integration. You may request the deletion of all your historically transmitted data via our API using your unique integration token.
